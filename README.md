...
hand-editing `apps/values.yaml` and without getting the git dance wrong.
...
One file, standard library only, no packages to install. Written for the system
python on the DLS RHEL8 machines (3.12); works on 3.8 and later.
